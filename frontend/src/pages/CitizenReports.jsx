...
import { 
  Search, Plus, X, RefreshCw, MapPin, AlertTriangle, Calendar,
  Clock, CheckCircle, Eye, ThumbsUp, MessageCircle, Send, Filter, 
  TrendingUp, Phone, Mail, User, FileText
} from 'lucide-react'
import api from '../api'
...
// ✅ THIS IS THE CRITICAL EXPORT DEFAULT STATEMENT
    ...
    <div style={{ minHeight: 'calc(100vh - 70px)', background: '#f8fafc', padding: '24px' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <h1 style={{ margin: '0 0 8px', fontSize: '28px', fontWeight: '800', color: '#0f172a' }}>Citizen Reports</h1>
            <p style={{ margin: 0, fontSize: '15px', color: '#64748b' }}>Report water issues and track their resolution in real-time</p>
          </div>
            ...
            <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} exit={{ scale: 0.9 }}
              ...
              <form onSubmit={handleSubmitReport} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <FormField label="Detailed Description *" required>
                  <textarea required value={newReport.description} onChange={(e) => setNewReport({ ...newReport, description: e.target.value })} placeholder="Please describe the issue in detail..." rows={4} style={{ ...inputStyle, resize: 'vertical' }} />
                </FormField>
...
// ============================================
// REUSABLE COMPONENTS (MUST BE OUTSIDE THE MAIN FUNCTION)
// ============================================
